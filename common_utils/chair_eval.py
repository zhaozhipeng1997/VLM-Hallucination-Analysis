...
# Resolve config import relative to project root
import sys as _sys
_REPO_ROOT = Path(__file__).resolve().parents[1]
if str(_REPO_ROOT) not in _sys.path:
    _sys.path.insert(0, str(_REPO_ROOT))
from config import COCO_ANNOTATIONS_ROOT
...
def chair_eval(cap_file, image_id_key:str="image_id", caption_key:str="caption", coco_path:str=COCO_ANNOTATIONS_ROOT, save_path:str=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='output/captions.jsonl',
    ...
    parser.add_argument("--coco_path", type=str, default='data/coco/annotations/',
