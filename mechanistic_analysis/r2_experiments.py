...
Usage:
    ...
    python mechanistic_analysis/r2_experiments.py --experiment r1 --model llava-1.5 --num_images 50

    # R2 (requires model, ~30 min per model):
    python mechanistic_analysis/r2_experiments.py --experiment r2 --model llava-1.5 --num_images 50

    # R3 (requires model, ~30 min per model):
    python mechanistic_analysis/r2_experiments.py --experiment r3 --model llava-1.5 --num_images 50

    # All three:
    python mechanistic_analysis/r2_experiments.py --experiment all --model llava-1.5
"""
...
OUTPUT_DIR = REPO_ROOT / "results" / "r2"
