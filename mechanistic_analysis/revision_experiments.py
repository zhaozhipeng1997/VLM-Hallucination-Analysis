...
Usage:
    ...
    python mechanistic_analysis/revision_experiments.py --experiment p0

    # P1 (needs GPU + model):
    python mechanistic_analysis/revision_experiments.py --experiment p1 --model llava-1.5

    # P2 only (fast, uses existing npz data):
    python mechanistic_analysis/revision_experiments.py --experiment p2

    # All three:
    python mechanistic_analysis/revision_experiments.py --experiment all --model llava-1.5
"""
